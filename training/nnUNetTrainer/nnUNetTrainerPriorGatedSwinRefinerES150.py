...
class nnUNetTrainerPriorGatedSwinRefinerES150(nnUNetTrainerPriorGatedSwinRefiner):
    """Prior-gated Swin refiner with a fixed 150-epoch budget."""
...
PriorGatedSwinRefinerES150Trainer = nnUNetTrainerPriorGatedSwinRefinerES150

...
def maybe_load_checkpoint(nnunet_trainer: nnUNetTrainer, continue_training: bool, validation_only: bool,
    ...
    if continue_training:
        ...
        checkpoint_name = 'checkpoint_best.pth' if val_with_best else 'checkpoint_final.pth'
        expected_checkpoint_file = join(nnunet_trainer.output_folder, checkpoint_name)
        if not isfile(expected_checkpoint_file):
            raise RuntimeError(f"Cannot run validation because {checkpoint_name} is missing!")
    else:

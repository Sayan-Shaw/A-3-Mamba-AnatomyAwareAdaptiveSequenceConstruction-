...
nnUNet_raw          = os.environ.get('nnUNet_raw',          "/storage/ss_sayan/CrossInstMalePelvic/data/nnUNet_raw")
nnUNet_preprocessed = os.environ.get('nnUNet_preprocessed', "/storage/ss_sayan/CrossInstMalePelvic/data/nnUNet_preprocessed_latest")
nnUNet_results      = os.environ.get('nnUNet_results',      "/storage/ss_sayan/CrossInstMalePelvic/data/nnUNet_results")
